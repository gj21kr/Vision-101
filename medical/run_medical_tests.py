...
def main():
    ...
    non_medical_dir = project_root / 'non_medical'

    # Define algorithms to run
    algorithms = {
        # Core algorithms
        'vae': {
            'script': non_medical_dir / 'generating' / 'vae_medical_example.py',
            'name': 'Medical VAE'
        },
        'gan': {
            'script': non_medical_dir / 'generating' / 'gan_medical_example.py',
            'name': 'Medical GAN'
        },
        'nerf': {
            'script': non_medical_dir / '3d' / 'nerf_medical_example.py',
            'name': 'Medical NeRF'
        },

        # GAN Variants
        'dcgan': {
            'script': non_medical_dir / 'generating' / 'gan_variants' / 'dcgan_medical_example.py',
            'name': 'Medical DCGAN'
        },
        'wgan': {
            'script': non_medical_dir / 'generating' / 'gan_variants' / 'wgan_medical_example.py',
            'name': 'Medical WGAN'
        },
        'wgan_gp': {
            'script': non_medical_dir / 'generating' / 'gan_variants' / 'wgan_gp_medical_example.py',
            'name': 'Medical WGAN-GP'
        },
        'stylegan': {
            'script': non_medical_dir / 'generating' / 'gan_variants' / 'stylegan_medical_example.py',
            'name': 'Medical StyleGAN'
        },
        'cyclegan': {
            'script': non_medical_dir / 'generating' / 'gan_variants' / 'cyclegan_medical_example.py',
            'name': 'Medical CycleGAN'
        },
        'conditional_gan': {
            'script': non_medical_dir / 'generating' / 'gan_variants' / 'conditional_gan_medical_example.py',
            'name': 'Medical Conditional GAN'
        },

        # Diffusion Models
        'ddpm': {
            'script': non_medical_dir / 'generating' / 'diffusion_variants' / 'ddpm_medical_example.py',
            'name': 'Medical DDPM'
        },
        'ddim': {
            'script': non_medical_dir / 'generating' / 'diffusion_variants' / 'ddim_medical_example.py',
            'name': 'Medical DDIM'
        },
        'latent_diffusion': {
            'script': non_medical_dir / 'generating' / 'diffusion_variants' / 'latent_diffusion_medical_example.py',
            'name': 'Medical Latent Diffusion'
        },
        'score_based_sde': {
            'script': non_medical_dir / 'generating' / 'diffusion_variants' / 'score_based_diffusion_medical_example.py',
            'name': 'Medical Score-based SDE'
        },
        'conditional_diffusion': {
            'script': non_medical_dir / 'generating' / 'diffusion_variants' / 'conditional_diffusion_medical_example.py',
    ...
    for algo_key in algorithms_to_run:
        ...
        results_summary['algorithms'][algo_key] = {
            ...
            'success': success,
            'execution_time': end_time - start_time,
            'script_path': str(algo_info['script'])
        }
    ...
    print(f"  {results_dir}/")
    print("  Each algorithm creates its own timestamped subdirectory")
